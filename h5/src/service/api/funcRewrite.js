  ...
  if (isIOS) {
    ...
    window.setTimeout = function (fn, timer) {
      if (typeof fn !== 'function') {
        throw new TypeError(
          'setTimetout expects a function as first argument but got ' +
            typeof fn +
            '.'
        )
      }
      var callback = Reporter.surroundThirdByTryCatch(
        fn,
    ...
    window.setInterval = function (fn, timer) {
      if (typeof fn !== 'function') {
        throw new TypeError(
          'setInterval expects a function as first argument but got ' +
            typeof fn +
            '.'
        )
      }
